 ...
 */
package com.sql.dialect.oracle.visitor;

import java.util.List;

import com.sql.ast.SQLArgument;
...
import com.sql.ast.statement.SQLCheck;
...
import com.sql.ast.statement.SQLJoinTableSource;
import com.sql.ast.statement.SQLJoinTableSource.JoinType;
import com.sql.ast.statement.SQLRollbackStatement;
import com.sql.ast.statement.SQLSavePointStatement;
import com.sql.ast.statement.SQLScriptCommitStatement;
...
import com.sql.ast.statement.SQLTruncateStatement;
import com.sql.ast.statement.SQLUnique;
import com.sql.ast.statement.SQLWithSubqueryClause;
import com.sql.dialect.oracle.ast.OracleDataTypeIntervalDay;
import com.sql.dialect.oracle.ast.OracleDataTypeIntervalYear;
import com.sql.dialect.oracle.ast.clause.CycleClause;
import com.sql.dialect.oracle.ast.clause.ModelClause;
import com.sql.dialect.oracle.ast.clause.ModelClause.CellAssignment;
import com.sql.dialect.oracle.ast.clause.ModelClause.CellAssignmentItem;
import com.sql.dialect.oracle.ast.clause.ModelClause.CellReferenceOption;
import com.sql.dialect.oracle.ast.clause.ModelClause.MainModelClause;
import com.sql.dialect.oracle.ast.clause.ModelClause.ModelColumn;
import com.sql.dialect.oracle.ast.clause.ModelClause.ModelColumnClause;
import com.sql.dialect.oracle.ast.clause.ModelClause.ModelRuleOption;
import com.sql.dialect.oracle.ast.clause.ModelClause.ModelRulesClause;
import com.sql.dialect.oracle.ast.clause.ModelClause.QueryPartitionClause;
import com.sql.dialect.oracle.ast.clause.ModelClause.ReferenceModelClause;
import com.sql.dialect.oracle.ast.clause.ModelClause.ReturnRowsClause;
import com.sql.dialect.oracle.ast.clause.OracleLobStorageClause;
import com.sql.dialect.oracle.ast.clause.OracleReturningClause;
import com.sql.dialect.oracle.ast.clause.OracleStorageClause;
import com.sql.dialect.oracle.ast.clause.OracleWithSubqueryEntry;
import com.sql.dialect.oracle.ast.clause.PartitionExtensionClause;
import com.sql.dialect.oracle.ast.clause.SampleClause;
import com.sql.dialect.oracle.ast.clause.SearchClause;
import com.sql.dialect.oracle.ast.expr.OracleAnalytic;
import com.sql.dialect.oracle.ast.expr.OracleAnalyticWindowing;
import com.sql.dialect.oracle.ast.expr.OracleArgumentExpr;
import com.sql.dialect.oracle.ast.expr.OracleBinaryDoubleExpr;
import com.sql.dialect.oracle.ast.expr.OracleBinaryFloatExpr;
import com.sql.dialect.oracle.ast.expr.OracleCursorExpr;
import com.sql.dialect.oracle.ast.expr.OracleDatetimeExpr;
import com.sql.dialect.oracle.ast.expr.OracleDbLinkExpr;
import com.sql.dialect.oracle.ast.expr.OracleIntervalExpr;
import com.sql.dialect.oracle.ast.expr.OracleIsOfTypeExpr;
import com.sql.dialect.oracle.ast.expr.OracleIsSetExpr;
import com.sql.dialect.oracle.ast.expr.OracleOuterExpr;
import com.sql.dialect.oracle.ast.expr.OracleRangeExpr;
import com.sql.dialect.oracle.ast.expr.OracleSizeExpr;
import com.sql.dialect.oracle.ast.expr.OracleSysdateExpr;
import com.sql.dialect.oracle.ast.expr.OracleTreatExpr;
import com.sql.dialect.oracle.ast.stmt.OracleAlterIndexStatement;
import com.sql.dialect.oracle.ast.stmt.OracleAlterIndexStatement.Rebuild;
import com.sql.dialect.oracle.ast.stmt.OracleAlterSessionStatement;
import com.sql.dialect.oracle.ast.stmt.OracleAlterSynonymStatement;
import com.sql.dialect.oracle.ast.stmt.OracleAlterTableDropPartition;
import com.sql.dialect.oracle.ast.stmt.OracleAlterTableModify;
import com.sql.dialect.oracle.ast.stmt.OracleAlterTableMoveTablespace;
import com.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition;
import com.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.NestedTablePartitionSpec;
import com.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.TableSpaceItem;
import com.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.UpdateIndexesClause;
import com.sql.dialect.oracle.ast.stmt.OracleAlterTableTruncatePartition;
import com.sql.dialect.oracle.ast.stmt.OracleAlterTablespaceAddDataFile;
import com.sql.dialect.oracle.ast.stmt.OracleAlterTablespaceStatement;
import com.sql.dialect.oracle.ast.stmt.OracleAlterTriggerStatement;
import com.sql.dialect.oracle.ast.stmt.OracleAlterViewStatement;
import com.sql.dialect.oracle.ast.stmt.OracleCheck;
import com.sql.dialect.oracle.ast.stmt.OracleConstraint;
import com.sql.dialect.oracle.ast.stmt.OracleContinueStatement;
import com.sql.dialect.oracle.ast.stmt.OracleCreateDatabaseDbLinkStatement;
import com.sql.dialect.oracle.ast.stmt.OracleCreateIndexStatement;
import com.sql.dialect.oracle.ast.stmt.OracleCreatePackageStatement;
import com.sql.dialect.oracle.ast.stmt.OracleCreateSynonymStatement;
import com.sql.dialect.oracle.ast.stmt.OracleCreateTableStatement;
import com.sql.dialect.oracle.ast.stmt.OracleCreateTypeStatement;
import com.sql.dialect.oracle.ast.stmt.OracleDeleteStatement;
import com.sql.dialect.oracle.ast.stmt.OracleDropDbLinkStatement;
import com.sql.dialect.oracle.ast.stmt.OracleExceptionStatement;
import com.sql.dialect.oracle.ast.stmt.OracleExecuteImmediateStatement;
import com.sql.dialect.oracle.ast.stmt.OracleExitStatement;
import com.sql.dialect.oracle.ast.stmt.OracleExplainStatement;
import com.sql.dialect.oracle.ast.stmt.OracleFileSpecification;
import com.sql.dialect.oracle.ast.stmt.OracleForStatement;
import com.sql.dialect.oracle.ast.stmt.OracleForeignKey;
import com.sql.dialect.oracle.ast.stmt.OracleGotoStatement;
import com.sql.dialect.oracle.ast.stmt.OracleInsertStatement;
import com.sql.dialect.oracle.ast.stmt.OracleLabelStatement;
import com.sql.dialect.oracle.ast.stmt.OracleLockTableStatement;
import com.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement;
import com.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.ConditionalInsertClause;
import com.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.ConditionalInsertClauseItem;
import com.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.InsertIntoClause;
import com.sql.dialect.oracle.ast.stmt.OraclePipeRowStatement;
import com.sql.dialect.oracle.ast.stmt.OraclePrimaryKey;
import com.sql.dialect.oracle.ast.stmt.OracleRaiseStatement;
import com.sql.dialect.oracle.ast.stmt.OracleRunStatement;
import com.sql.dialect.oracle.ast.stmt.OracleSelectJoin;
import com.sql.dialect.oracle.ast.stmt.OracleSelectPivot;
import com.sql.dialect.oracle.ast.stmt.OracleSelectPivot.Item;
import com.sql.dialect.oracle.ast.stmt.OracleSelectPivotBase;
import com.sql.dialect.oracle.ast.stmt.OracleSelectQueryBlock;
import com.sql.dialect.oracle.ast.stmt.OracleSelectRestriction;
import com.sql.dialect.oracle.ast.stmt.OracleSelectRestriction.CheckOption;
import com.sql.dialect.oracle.ast.stmt.OracleSelectRestriction.ReadOnly;
import com.sql.dialect.oracle.ast.stmt.OracleSelectSubqueryTableSource;
import com.sql.dialect.oracle.ast.stmt.OracleSelectTableReference;
import com.sql.dialect.oracle.ast.stmt.OracleSelectUnPivot;
import com.sql.dialect.oracle.ast.stmt.OracleSetTransactionStatement;
import com.sql.dialect.oracle.ast.stmt.OracleSupplementalIdKey;
import com.sql.dialect.oracle.ast.stmt.OracleSupplementalLogGrp;
import com.sql.dialect.oracle.ast.stmt.OracleUnique;
import com.sql.dialect.oracle.ast.stmt.OracleUpdateStatement;
import com.sql.dialect.oracle.ast.stmt.OracleUsingIndexClause;
import com.sql.dialect.oracle.parser.OracleFunctionDataType;
import com.sql.dialect.oracle.parser.OracleProcedureDataType;
...
//    }
    ...
    @Override
    public void endVisit(com.sql.dialect.oracle.ast.stmt.OracleExceptionStatement.Item x) {

    }

    @Override
    public boolean visit(com.sql.dialect.oracle.ast.stmt.OracleExceptionStatement.Item x) {
        print0(ucase ? "WHEN " : "when ");
        x.getWhen().accept(this);
        print0(ucase ? " THEN" : " then");
