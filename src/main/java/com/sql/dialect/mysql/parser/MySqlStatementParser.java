 ...
 */
package com.sql.dialect.mysql.parser;

import java.util.ArrayList;
import java.util.List;

import com.sql.SQLUtils;
import com.sql.ast.SQLCommentHint;
import com.sql.ast.SQLDataType;
import com.sql.ast.SQLDataTypeImpl;
import com.sql.ast.SQLDeclareItem;
import com.sql.ast.SQLExpr;
import com.sql.ast.SQLName;
import com.sql.ast.SQLObject;
import com.sql.ast.SQLOrderBy;
import com.sql.ast.SQLParameter;
import com.sql.ast.SQLParameter.ParameterType;
import com.sql.ast.SQLPartition;
...
import com.sql.ast.expr.SQLLiteralExpr;
import com.sql.ast.expr.SQLPropertyExpr;
import com.sql.ast.expr.SQLQueryExpr;
import com.sql.ast.expr.SQLVariantRefExpr;
import com.sql.ast.statement.SQLAlterCharacter;
import com.sql.ast.statement.SQLAlterDatabaseStatement;
import com.sql.ast.statement.SQLAlterFunctionStatement;
import com.sql.ast.statement.SQLAlterProcedureStatement;
import com.sql.ast.statement.SQLAlterTableAddColumn;
import com.sql.ast.statement.SQLAlterTableAddConstraint;
import com.sql.ast.statement.SQLAlterTableAddIndex;
import com.sql.ast.statement.SQLAlterTableAddPartition;
import com.sql.ast.statement.SQLAlterTableAnalyzePartition;
import com.sql.ast.statement.SQLAlterTableCheckPartition;
import com.sql.ast.statement.SQLAlterTableCoalescePartition;
import com.sql.ast.statement.SQLAlterTableConvertCharSet;
import com.sql.ast.statement.SQLAlterTableDisableConstraint;
import com.sql.ast.statement.SQLAlterTableDisableKeys;
import com.sql.ast.statement.SQLAlterTableDiscardPartition;
import com.sql.ast.statement.SQLAlterTableDropColumnItem;
import com.sql.ast.statement.SQLAlterTableDropConstraint;
import com.sql.ast.statement.SQLAlterTableDropForeignKey;
import com.sql.ast.statement.SQLAlterTableDropIndex;
import com.sql.ast.statement.SQLAlterTableDropKey;
import com.sql.ast.statement.SQLAlterTableDropPartition;
import com.sql.ast.statement.SQLAlterTableDropPrimaryKey;
import com.sql.ast.statement.SQLAlterTableEnableConstraint;
import com.sql.ast.statement.SQLAlterTableEnableKeys;
import com.sql.ast.statement.SQLAlterTableExchangePartition;
import com.sql.ast.statement.SQLAlterTableImportPartition;
import com.sql.ast.statement.SQLAlterTableOptimizePartition;
import com.sql.ast.statement.SQLAlterTableReOrganizePartition;
import com.sql.ast.statement.SQLAlterTableRebuildPartition;
import com.sql.ast.statement.SQLAlterTableRename;
import com.sql.ast.statement.SQLAlterTableRenameIndex;
import com.sql.ast.statement.SQLAlterTableRepairPartition;
import com.sql.ast.statement.SQLAlterTableStatement;
import com.sql.ast.statement.SQLAlterTableTruncatePartition;
import com.sql.ast.statement.SQLAlterViewStatement;
import com.sql.ast.statement.SQLBlockStatement;
import com.sql.ast.statement.SQLColumnDefinition;
import com.sql.ast.statement.SQLCommitStatement;
import com.sql.ast.statement.SQLCreateDatabaseStatement;
import com.sql.ast.statement.SQLCreateFunctionStatement;
import com.sql.ast.statement.SQLCreateIndexStatement;
import com.sql.ast.statement.SQLCreateProcedureStatement;
import com.sql.ast.statement.SQLCreateTableStatement;
import com.sql.ast.statement.SQLExprStatement;
import com.sql.ast.statement.SQLExprTableSource;
import com.sql.ast.statement.SQLIfStatement;
import com.sql.ast.statement.SQLInsertStatement;
import com.sql.ast.statement.SQLLoopStatement;
import com.sql.ast.statement.SQLPrimaryKey;
import com.sql.ast.statement.SQLReplaceStatement;
import com.sql.ast.statement.SQLRollbackStatement;
import com.sql.ast.statement.SQLSelect;
import com.sql.ast.statement.SQLSelectOrderByItem;
import com.sql.ast.statement.SQLSelectStatement;
import com.sql.ast.statement.SQLSetStatement;
import com.sql.ast.statement.SQLShowTablesStatement;
import com.sql.ast.statement.SQLStartTransactionStatement;
...
import com.sql.ast.statement.SQLUpdateSetItem;
import com.sql.ast.statement.SQLUpdateStatement;
import com.sql.ast.statement.SQLWhileStatement;
import com.sql.dialect.mysql.ast.MysqlForeignKey;
import com.sql.dialect.mysql.ast.clause.ConditionValue;
import com.sql.dialect.mysql.ast.clause.ConditionValue.ConditionType;
import com.sql.dialect.mysql.ast.clause.MySqlCaseStatement;
import com.sql.dialect.mysql.ast.clause.MySqlCaseStatement.MySqlWhenStatement;
import com.sql.dialect.mysql.ast.clause.MySqlCursorDeclareStatement;
import com.sql.dialect.mysql.ast.clause.MySqlDeclareConditionStatement;
import com.sql.dialect.mysql.ast.clause.MySqlDeclareHandlerStatement;
import com.sql.dialect.mysql.ast.clause.MySqlDeclareStatement;
import com.sql.dialect.mysql.ast.clause.MySqlHandlerType;
import com.sql.dialect.mysql.ast.clause.MySqlIterateStatement;
import com.sql.dialect.mysql.ast.clause.MySqlLeaveStatement;
import com.sql.dialect.mysql.ast.clause.MySqlRepeatStatement;
import com.sql.dialect.mysql.ast.clause.MySqlSelectIntoStatement;
import com.sql.dialect.mysql.ast.statement.CobarShowStatus;
import com.sql.dialect.mysql.ast.statement.MySqlAlterEventStatement;
import com.sql.dialect.mysql.ast.statement.MySqlAlterLogFileGroupStatement;
import com.sql.dialect.mysql.ast.statement.MySqlAlterServerStatement;
import com.sql.dialect.mysql.ast.statement.MySqlAlterTableAlterColumn;
import com.sql.dialect.mysql.ast.statement.MySqlAlterTableChangeColumn;
import com.sql.dialect.mysql.ast.statement.MySqlAlterTableDiscardTablespace;
import com.sql.dialect.mysql.ast.statement.MySqlAlterTableImportTablespace;
import com.sql.dialect.mysql.ast.statement.MySqlAlterTableModifyColumn;
import com.sql.dialect.mysql.ast.statement.MySqlAlterTableOption;
import com.sql.dialect.mysql.ast.statement.MySqlAlterTablespaceStatement;
import com.sql.dialect.mysql.ast.statement.MySqlAlterUserStatement;
import com.sql.dialect.mysql.ast.statement.MySqlAnalyzeStatement;
import com.sql.dialect.mysql.ast.statement.MySqlBinlogStatement;
import com.sql.dialect.mysql.ast.statement.MySqlChecksumTableStatement;
import com.sql.dialect.mysql.ast.statement.MySqlCreateAddLogFileGroupStatement;
import com.sql.dialect.mysql.ast.statement.MySqlCreateEventStatement;
import com.sql.dialect.mysql.ast.statement.MySqlCreateServerStatement;
import com.sql.dialect.mysql.ast.statement.MySqlCreateTableSpaceStatement;
import com.sql.dialect.mysql.ast.statement.MySqlCreateTableStatement;
import com.sql.dialect.mysql.ast.statement.MySqlCreateUserStatement;
import com.sql.dialect.mysql.ast.statement.MySqlDeleteStatement;
import com.sql.dialect.mysql.ast.statement.MySqlEventSchedule;
import com.sql.dialect.mysql.ast.statement.MySqlExecuteStatement;
import com.sql.dialect.mysql.ast.statement.MySqlExplainStatement;
import com.sql.dialect.mysql.ast.statement.MySqlFlushStatement;
import com.sql.dialect.mysql.ast.statement.MySqlHelpStatement;
import com.sql.dialect.mysql.ast.statement.MySqlHintStatement;
import com.sql.dialect.mysql.ast.statement.MySqlInsertStatement;
import com.sql.dialect.mysql.ast.statement.MySqlKillStatement;
import com.sql.dialect.mysql.ast.statement.MySqlLoadDataInFileStatement;
import com.sql.dialect.mysql.ast.statement.MySqlLoadXmlStatement;
import com.sql.dialect.mysql.ast.statement.MySqlLockTableStatement;
import com.sql.dialect.mysql.ast.statement.MySqlLockTableStatement.LockType;
import com.sql.dialect.mysql.ast.statement.MySqlOptimizeStatement;
import com.sql.dialect.mysql.ast.statement.MySqlPrepareStatement;
import com.sql.dialect.mysql.ast.statement.MySqlRenameTableStatement;
import com.sql.dialect.mysql.ast.statement.MySqlResetStatement;
import com.sql.dialect.mysql.ast.statement.MySqlSetTransactionStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowAuthorsStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowBinLogEventsStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowBinaryLogsStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowCharacterSetStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowCollationStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowColumnsStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowContributorsStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowCreateDatabaseStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowCreateEventStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowCreateFunctionStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowCreateProcedureStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowCreateTableStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowCreateTriggerStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowCreateViewStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowDatabasePartitionStatusStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowDatabasesStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowEngineStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowEnginesStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowErrorsStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowEventsStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowFunctionCodeStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowFunctionStatusStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowGrantsStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowIndexesStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowKeysStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowMasterLogsStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowMasterStatusStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowOpenTablesStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowPluginsStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowPrivilegesStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowProcedureCodeStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowProcedureStatusStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowProcessListStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowProfileStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowProfilesStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowRelayLogEventsStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowSlaveHostsStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowSlaveStatusStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowStatusStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowTableStatusStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowTriggersStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowVariantsStatement;
import com.sql.dialect.mysql.ast.statement.MySqlShowWarningsStatement;
import com.sql.dialect.mysql.ast.statement.MySqlUnlockTablesStatement;
import com.sql.dialect.mysql.ast.statement.MySqlUpdateStatement;
import com.sql.dialect.mysql.ast.statement.MysqlDeallocatePrepareStatement;
import com.sql.parser.EOFParserException;
import com.sql.parser.InsertColumnsCache;
