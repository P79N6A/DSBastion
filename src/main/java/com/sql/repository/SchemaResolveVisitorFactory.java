...
import com.sql.ast.expr.SQLBinaryOpExprGroup;
...
import com.sql.ast.statement.SQLForeignKeyConstraint;
...
import com.sql.ast.statement.SQLLateralViewTableSource;
...
import com.sql.ast.statement.SQLTableElement;
...
import com.sql.dialect.mysql.visitor.MySqlASTVisitorAdapter;
import com.sql.dialect.odps.ast.OdpsCreateTableStatement;
import com.sql.dialect.odps.ast.OdpsSelectQueryBlock;
import com.sql.dialect.odps.visitor.OdpsASTVisitorAdapter;
...
import com.sql.dialect.oracle.visitor.OracleASTVisitorAdapter;
...
import com.sql.dialect.postgresql.visitor.PGASTVisitorAdapter;
import com.sql.dialect.sqlserver.ast.SQLServerSelectQueryBlock;
import com.sql.dialect.sqlserver.ast.stmt.SQLServerInsertStatement;
import com.sql.dialect.sqlserver.ast.stmt.SQLServerUpdateStatement;
import com.sql.dialect.sqlserver.visitor.SQLServerASTVisitorAdapter;
...
class SchemaResolveVisitorFactory {
    ...
    static class PGResolveVisitor extends PGASTVisitorAdapter implements SchemaResolveVisitor {
        ...
        public boolean visit(SQLIdentifierExpr x) {
            if (FnvHash.isPseudoColumn(x.nameHashCode64())) {
                return false;
            }
